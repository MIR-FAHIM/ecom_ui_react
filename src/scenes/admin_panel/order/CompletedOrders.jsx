...
import { getCompletedOrder, deleteOrder, updateOrderStatus } from "../../../api/controller/admin_controller/order/order_controller";
...
const CompletedOrders = () => {
  ...
  const fetchOrders = async (pageZeroBased = 0, perPage = 10) => {
    try {
      ...
      const response = await getCompletedOrder(params);
